        ...
        <div className="bg-surface-container-high rounded-xl overflow-hidden shadow-sm group border border-outline-variant/20 cursor-pointer">
            <div className="relative h-48">
                ...
                <div className="absolute top-4 left-4">
                    <span className="bg-tertiary-container text-on-tertiary-container px-3 py-1 rounded-full text-[10px] font-extrabold uppercase tracking-widest">
                        {tag}
                    </span>
                </div>
            </div>
            <div className="p-6">
                ...
                <p className="text-on-surface-variant text-sm leading-relaxed mb-4">{excerpt}</p>
                <div className="flex items-center justify-between pt-4 border-t border-outline-variant/20">
                    ...
                    <span className="text-[11px] text-outline font-medium">{readTime}</span>
                </div>
            </div>
        </div>
    );
