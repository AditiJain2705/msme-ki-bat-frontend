            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-16 items-start">
                    ...
                    <div className="flex flex-col md:items-center mb-44 md:mb-0">
                        ...
                        <div className="mt-6 relative w-full md:w-[360px] md:max-w-full flex items-center justify-center" >
                            <div className="absolute top-0 flex flex-col items-center justify-center text-center md:mt-10">
                                <h3 className="font-rough text-[#02443A] text-center font-medium uppercase text-[28px] leading-[38px] mb-4">{`{1st Month}`}</h3>

                                <ul className="space-y-7 text-textInk leading-relaxed ">
                                    <li className="flex gap-4 items-center">
                                        ...
                                        <span className="nave-font text-left nave-font text-[16px] md:text-[19px] leading-[20px] md:leading-[22px] text-[#1A1A1A] tracking-[0.017em]">Understand your fit and <br />explore roles.</span>
                                    </li>
                                    ...
                                    <li className="flex gap-4 items-center">
                                        ...
                                        <span className="nave-font text-left nave-font text-[16px] md:text-[19px] leading-[20px] md:leading-[22px] text-[#1A1A1A] tracking-[0.017em]">Conduct user-testing, <br />discover founder <br />stories, and map local <br />startup hubs.</span>
                                    </li>
                                </ul>
                    ...
                    <div className="flex flex-col items-center mb-40 md:mb-0">
                        ...
                        <div className="mt-6 relative w-[360px] max-w-full flex items-center justify-center">
                            <div className="absolute top-0 flex flex-col items-center justify-center text-center z-[999] md:mt-10">
                                <h3 className="font-rough text-[#02443A] text-center font-medium uppercase text-[28px] leading-[38px] mb-4">{`{2nd Month}`}</h3>
                                ...
                                <ul className="space-y-7 text-textInk leading-relaxed">
                                    <li className="flex gap-4 items-center">
                                        ...
                                        <span className="nave-font text-left nave-font text-[16px] md:text-[19px] leading-[20px] md:leading-[22px] text-[#1A1A1A] tracking-[0.017em]">₹5,000/month stipend + <br />certification</span>
                                    </li>
                                    ...
                                    <li className="flex gap-4 items-center">
                                        ...
                                        <span className="nave-font text-left nave-font text-[16px] md:text-[19px] leading-[20px] md:leading-[22px] text-[#1A1A1A] tracking-[0.017em]">Lead product tests, <br />create content, mentor <br />newer fellows</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div className="flex flex-col items-center mb-28 md:mb-0">
                        ...
                        <div className="mt-6 relative w-[360px] max-w-full flex items-center justify-center">
                            <div className="absolute top-0 flex flex-col items-center justify-center text-center z-[999] md:mt-10">
                                <h3 className="font-rough text-[#02443A] text-center font-medium uppercase text-[28px] leading-[38px] mb-4">{`{3rd Month}`}</h3>
                                ...
                                <ul className="space-y-7 text-textInk leading-relaxed">
                                    <li className="flex gap-4 items-center">
                                        ...
                                        <span className="nave-font text-left nave-font text-[16px] md:text-[19px] leading-[20px] md:leading-[22px] text-[#1A1A1A] tracking-[0.017em]">3 Months, optional</span>
                                    </li>
                                    ...
                                    <li className="flex gap-4 items-center">
                                        ...
                                        <span className="nave-font text-left nave-font text-[16px] md:text-[19px] leading-[20px] md:leading-[22px] text-[#1A1A1A] tracking-[0.017em]">₹7,000/month stipend + <br />leadership roles</span>
                                    </li>
                                    ...
                                    <li className="flex gap-4 items-center">
                                        ...
                                        <span className="text-left nave-font text-[19px] leading-[22px] text-[#1A1A1A] tracking-[0.017em]">Manage teams, drive <br />events, scale <br />successful initiatives</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div className="relative inline-block w-full pt-44 lg:pt-24">
                    <p className="text-center md:text-right font-rough uppercase text-[36px] md:text-[60px] lg:text-[70px] leading-[48px] md:leading-[80px] text-[#02443A]">
                        What Will You Do <br />as a <span className="text-[#E49800]">Fellow?</span>
                    </p>
                </div>
                    ...
                    <div className="max-w-5xl mx-auto px-6">
                        ...
                        <div className="grid md:grid-cols-2 gap-12 items-center">
                            ...
                            <div className="relative pt-8">
                                ...
                                <p className="font-rough text-[#02443A] text-[42px] leading-[54px] font-medium">
                                    Conduct at least 10 <span className="text-[#F63A49]"> weekly <br />user tests </span>(WhatsApp <br />Co-pilot)
                                </p>
                        ...
                        <div className="grid md:grid-cols-2 gap-12 items-center mt-14">
                            <div className="relative">
                                ...
                                <p className="nave-font text-[18px] leading-[30px] text-[#02443A] max-w-xl pt-10">
                        ...
                        <div className="grid md:grid-cols-2 gap-12 items-center mt-14">
                            ...
                            <div className="relative">
                                ...
                                <p className="font-rough text-[#02443A] text-[42px] leading-[54px] font-medium pb-4">
                        ...
                        <div className="grid md:grid-cols-2 gap-12 items-center mt-14">
                            <div className="relative">
                                ...
                                <p className="font-rough text-[#02443A] text-[42px] leading-[54px] font-medium">
                                    Collect <span className="text-[#F63A49]"> entrepreneur stories, challenges,<br /></span>and <span className="text-[#F63A49]">quotes.</span>
                                </p>

                                <p className="nave-font text-[18px] leading-[30px] text-[#02443A] max-w-xl pt-6 pr-6 mt-[2rem]">
